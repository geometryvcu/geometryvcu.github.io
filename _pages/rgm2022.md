...
<b>Congratulations to Shubham Sinha (UCSD)</b>, the winner of the Graduate Best Poster Award, for the poster titled 'Euler characteristics of tautological bundles over Quot scheme of curves.' A honorable mention goes to <b>Sally Collins (GA Tech)</b> for the poster titled 'The Mazur pattern, the figure eight knot, and smooth concordance.'

<b>Schedule</a>

<div class="embeddable_schedule" shortname="RVAGeometry2022" daterange="all"></div>
<script src="https://researchseminars.org/embed_seminars.js" onload="seminarEmbedder.initialize({'addCSS': true});"></script>

<div align="center">
	<img width = "50%" src="/assets/img/rgm2022poster.pdf">
</div>
